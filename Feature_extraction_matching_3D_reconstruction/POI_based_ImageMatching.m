...
%%define dataset path
params.Directory    = fullfile('Datasets/ImageMatching_Perspective4/');

%%Detector parameters
params.detector     =  'SURF'; %'LoG_ss', 'SURF', 'SIFT','DoG_ss', 'KAZE' ...
params.nscales      =        3;
params.noctaves     =        2;
...
params.descriptor   =  'SIFT'; % 'SIFT', 'SURF', 'DSP-SIFT', 'KAZE'...
